...
export class DashboardComponent implements OnInit {
  plateformes = [
    ...
    { value: "TABLETTE", viewValue: "TABLETTE" },
    { value: "SMARTPHONE", viewValue: "SMARTPHONE" }
  ];

  domaines = [
    { value: "E-LEARNING", viewValue: "E-LEARNING" },
    { value: "TEMPS REEL", viewValue: "TEMPS REEL" },
    { value: "JEUX", viewValue: "JEUX" },
    { value: "BUREAUTIQUE", viewValue: "BUREAUTIQUE" }
  ];

  populations = [
    { value: "PERSONNE AGEE", viewValue: "PERSONNE AGEE" },
    { value: "ENFANT", viewValue: "ENFANT" },
    { value: "MALVOYANTS", viewValue: "MALVOYANTS" },
